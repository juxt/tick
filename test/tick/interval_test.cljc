...
(deftest disjoint-test []
  (is (ti/disjoint?
        (ti/interval (instants 0) (instants 1))
        (ti/interval (instants 2) (instants 3))))
  (is (= (ti/disjoint?
           (ti/interval (instants 0) (instants 1))
           (ti/interval (instants 2) (instants 3))) ti/precedes?))
  (is (nil?
        (ti/disjoint?
          (ti/interval (instants 0) (instants 2))
          (ti/interval (instants 1) (instants 3)))))
  (is (nil?
        (ti/disjoint?
          (ti/interval (instants 0) (instants 3))
          (ti/interval (instants 1) (instants 2))))))
...
;; TODO: Support this: (ti/interval (t/now) (t/seconds 10))
;; TODO: Don't allow this: (ti/interval (t/now)) -- returns an illegal ti/interval
...
(deftest ordered-disjoint-intervals?-test
  ...
  (is
    (ti/ordered-disjoint-intervals?
      [(ti/interval (t/instant "2017-07-30T09:00:00Z")
                    (t/instant "2017-07-30T10:00:00Z"))
       (ti/interval (t/instant "2017-07-30T11:00:00Z")
                    (t/instant "2017-07-30T13:00:00Z"))]))
  (is
    (ti/ordered-disjoint-intervals?
      [(ti/interval (t/instant "2017-07-30T09:00:00Z")
  ...
  (is
    (ti/ordered-disjoint-intervals?
      [(ti/interval (t/instant "2017-07-30T09:00:00Z")
       ...
       (ti/interval (t/instant "2017-07-30T11:00:00Z")
                    (t/instant "2017-07-30T13:00:00Z"))
       (ti/interval (t/instant "2017-07-30T16:00:00Z")
...
(deftest intersection-test
  (let [coll1 [(ti/interval (t/instant "2017-01-01T06:00:00Z")
               ...
               (ti/interval (t/instant "2017-01-01T09:00:00Z")
        ...
        coll2 [(ti/interval (t/instant "2017-01-01T09:00:00Z")
               ...
               (ti/interval (t/instant "2017-01-01T11:00:00Z")
                            (t/instant "2017-01-01T12:00:00Z"))

               (ti/interval (t/instant "2017-01-01T14:00:00Z")
                            (t/instant "2017-01-01T18:00:00Z"))]]
    (is
      (= [(ti/interval (t/instant "2017-01-01T09:00:00Z") (t/instant "2017-01-01T10:00:00Z"))
          (ti/interval (t/instant "2017-01-01T11:00:00Z") (t/instant "2017-01-01T12:00:00Z"))
          (ti/interval (t/instant "2017-01-01T14:00:00Z") (t/instant "2017-01-01T15:00:00Z"))
          (ti/interval (t/instant "2017-01-01T17:00:00Z") (t/instant "2017-01-01T18:00:00Z"))]
  ...
  (let [coll1 [(ti/interval (t/instant "2017-01-01T08:00:00Z")
    ...
    (is
      (= [(ti/interval (t/instant "2017-01-01T09:00:00Z") (t/instant "2017-01-01T11:00:00Z"))
          (ti/interval (t/instant "2017-01-01T14:00:00Z") (t/instant "2017-01-01T16:00:00Z"))]
         (ti/intersection coll1 coll2))))
  ...
  (let [coll1 [(ti/interval (t/instant "2017-01-01T12:00:00Z")
                            (t/instant "2017-01-01T14:00:00Z"))]
        coll2 [(ti/interval (t/instant "2017-01-01T11:00:00Z")
                            (t/instant "2017-01-01T14:00:00Z"))]]
    (is (= [(ti/interval (t/instant "2017-01-01T12:00:00Z")
                         (t/instant "2017-01-01T14:00:00Z"))]
           (ti/intersection coll1 coll2))))

  (let [coll1 [(ti/interval (t/parse "2017-04-11T00:00")
                            (t/parse "2017-04-14T00:00"))
               (ti/interval (t/parse "2017-04-18T00:00")
                            (t/parse "2017-04-20T00:00"))
               (ti/interval (t/parse "2017-12-20T00:00")
                            (t/parse "2017-12-23T00:00"))
               (ti/interval (t/parse "2017-12-27T00:00")
                            (t/parse "2018-01-01T00:00"))
               (ti/interval (t/parse "2018-01-02T00:00")
                            (t/parse "2018-01-08T00:00"))]
        coll2 [(ti/bounds "2017")]]
    (is (= [(ti/interval (t/parse "2017-04-11T00:00")
                         (t/parse "2017-04-14T00:00"))
            (ti/interval (t/parse "2017-04-18T00:00")
                         (t/parse "2017-04-20T00:00"))
            (ti/interval (t/parse "2017-12-20T00:00")
...
(deftest difference-test
  ...
  (let [coll1 [(ti/interval (t/instant "2017-01-01T08:00:00Z")
    ...
    (is (=
          [(ti/interval (t/instant "2017-01-01T18:00:00Z")
                        (t/instant "2017-01-01T19:00:00Z"))]
          (ti/difference coll1 coll2))))
