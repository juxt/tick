...
(deftest division-test
  (is (= 365 (count (t// (t/year 2017) :date))))
  (is (= 12 (count (t// (t/year 2017) :year-month))))
  (is (= 30 (count (t// "2017-09" :date))))
  (is (= (t/date "2017-09-01") (first (t// "2017-09" :date))))
  (is (= (t/date "2017-09-30") (last (t// "2017-09" :date))))
  (is (= 31 (count (t// "2017-10" :date))))
  (is (= 8 (count (t// (t/bounds "2017-10-03" "2017-10-10") :date))))
  (is (= [(t/date "2017-09-10")] (t// (t/bounds "2017-09-10T12:00" "2017-09-10T14:00") :date)))
  (is (= [(t/date "2017-09-10") (t/date "2017-09-11")] (t// (t/bounds "2017-09-10T12:00" "2017-09-11T14:00") :date)))
  (is (= 2 (count (t// (t/bounds "2017-09-10" "2017-10-10") :year-month))))
  (is (= 3 (count (t// (t/bounds "2017-09-10T12:00" "2019") :year))))
  (is (= 3 (count (t// (t/bounds "2017-09-10T12:00" "2019-02") :year))))
  (is (= 24 (count (t// (t/date "2017-09-10") :hour)))))
...
(deftest holiday-counting-test
  ...
  (let [vacation (t/bounds (t/date "2017-04-11") (t/date "2017-04-19"))]
    ...
    (let [year (t/year 2017)
          ...
          weekends (filter cal/weekend? (t// year :date))
...
(deftest working-days-in-a-year-test
  (let [year (t/year 2017)
        ...
        weekends (map t/bounds (filter cal/weekend? (t// year :date)))]
