...
For longer durations, counting to high precision is unneccesary. If we are counting down the weeks, knowing how many seconds
...
CAUTION: These timers have lower accuracy at higher precissions - they do not account for leap seconds or years.